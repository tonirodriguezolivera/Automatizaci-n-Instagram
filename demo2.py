...
# ---------- Datos de prueba ----------
users = [
    {"user":"kevinarnold.zorem","password":"Xzorex123!","key":"M3NO VD76 36DM PH6M 5FKV UVPV YXF6 5JPI","new_password":"pass_nuevo2","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"sarasnyder1798","password":"6w437kb656","key":"WWQH L5BG FHLO ZDQL 3BJX PMTY EC2G LFPF","new_password":"pass_nuevo3","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"lisabarrett3952","password":"2jlvx3yar3","key":"6HSE HFCO JBVN AOTB 3MRK 6434 VDAV RKQU","new_password":"pass_nuevo4","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"rachelcarr6206","password":"4i8bh8bzm2","key":"Q5AP 77DS IVIR RGRB JV3M MRBU NV4N XUKS","new_password":"pass_nuevo5","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"nancypearson4528","password":"8eofzaosk6","key":"T5YE DPIT W43K Z56T IGV4 YFXU EFPS QJBI","new_password":"pass_nuevo6","avd_name":"Nexus_5_API_31_Clone2"},
    ...
    {"user":"francesjohnston90","password":"3o5sp1zve6","key":"TIJS G65E IVFZ 3VX5 6UBG JW6I SUVV AKC7","new_password":"pass_nuevo12","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"betty3739williams","password":"8xn7ci9qr0","key":"PPS6 JETO GX7G 7YUG XCII 2WTA BCJ2 TVOQ","new_password":"pass_nuevo13","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"dorothypatterson97","password":"7w5kvhrq82","key":"Z4WO UNU2 NP7D CPA2 HJON S3HE F7GW ZJKY","new_password":"pass_nuevo14","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"emmagonzalez3111","password":"104jp46tn3","key":"A2UH TUAL 53LI TP3D TNUX VNNL 4VHL 3VJV","new_password":"pass_nuevo15","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"catherinehill5495","password":"8pjuapfmo6","key":"5P2D 6LOK EDA7 ALPR HJ46 SJQI YGGM YV5O","new_password":"pass_nuevo16","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"victoriabanks734","password":"9n5pqt0ut4","key":"43NV HAWQ 6TQN LIAL 25QL SP7Y RSEM 2GXH","new_password":"pass_nuevo17","avd_name":"Nexus_5_API_31_Clone2"},
    {"user":"bettylarson312","password":"1dqrua8wl4","key":"BFCW P7YD HM47 T2F6 EVBE RGZY 72RX UPMQ","new_password":"pass_nuevo18","avd_name":"Nexus_5_API_31_Clone2"}
]
# -------------------------------------
...
async def start_infra_for_group(avd_name: str, port_offset: int):
    ...
    await Emulator.launch(
        ...
        no_snapshot=False,
        extra_args=[
            # cargar snapshot por defecto si existe
            "-snapshot", "default",
            # ahorrar tiempo de boot; NO afecta datos de usuario
            "-no-boot-anim",
        ],
        optimize=True
    )
